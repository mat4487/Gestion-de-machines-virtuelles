...
=======
%Ganeti nÃ©cessite un logiciel de virtualisation prÃ©-installÃ© sur les serveurs afin de pouvoir fonctionner. Une fois installÃ©, l'outil prendra en charge la partie gestion des instances virtuelles (Xen DomU), par exemple, la gestion de crÃ©ation de disque, l'installation du systÃ¨me d'exploitation (en coopÃ©ration avec les scripts d'installation du systÃ¨me d'exploitation spÃ©cifique), et le dÃ©marrage, l'arrÃªt, le basculement entre les systÃ¨mes physiques. Il a Ã©tÃ© conÃ§u pour faciliter la gestion de cluster de serveurs virtuels et de fournir une rÃ©cupÃ©ration rapide et simple.

\section{Installation}
\subsection{Modification des sources}
Nous avons intallÃ© ganeti Ã  partir de la branche testing de debian. Pour des raisons techniques le systÃ¨me est squeeze. Pour cela il faut ajouter les sources de testing dans le fichier /etc/apt/sources.list :
...
=======
\subsection{Mise Ã  jour et installation}
On peut enfin alors mettre le systÃ¨me Ã  jour et installer ganeti :
>>>>>>> bdb35216a929de37c6411ee8791b131964b0fad8
...
=======
\subsection{CrÃ©ation du bridge xen-br0}
BLABLABLA
\subsection{CrÃ©ation du LVM}
>>>>>>> bdb35216a929de37c6411ee8791b131964b0fad8
...
=======
%Par dÃ©faut le mirroir utilisÃ© par ganeti est http://ftp.us.debian.org/debian/. Sur Grid5000 les depots US sont bloquÃ©s. Il faut donc indiquer les depots francais. On indique aussi l'adresse du  proxy de grid5000. On peut choisir la version de Debian que l'on souhaite installer. Ici nous avons opter pour squeeze. L'architecture que nous choisi est amd64, car l'hÃ´te la supporte. La variable : EXTRA_PKGS permet d'installer des paquets supplÃ©mentaires.
>>>>>>> bdb35216a929de37c6411ee8791b131964b0fad8
...
\section{Utilisation des nodes}
\subsection{Ajouter un node}
Il est possible d'ajouter un node Ã  tout moment :
>>>>>>> bdb35216a929de37c6411ee8791b131964b0fad8
\begin{lstlisting}
...
=======
%On voit que le node griffon-81 n'Ã©tait pas master avant l'utilisation de la commande. Ensuite il est possible d'executer les commandes master.
>>>>>>> bdb35216a929de37c6411ee8791b131964b0fad8
...
=======
\subsubsection{Passer un node en mode regular (remise Ã  zero de tous les flags) :}
>>>>>>> bdb35216a929de37c6411ee8791b131964b0fad8
\begin{lstlisting}
